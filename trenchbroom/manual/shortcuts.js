...
const menu = {
    ...
    'Menu/Edit/Create Linked Duplicate': { path: ['Edit', 'Create Linked Duplicate'], shortcut: { key: 'D', modifiers: ['Ctrl', 'Shift', ] } },
    'Menu/Edit/Select Linked Groups': { path: ['Edit', 'Select Linked Groups'], shortcut: { key: '', modifiers: [] } },
    'Menu/Edit/Separate Linked Groups': { path: ['Edit', 'Separate Selected Groups'], shortcut: { key: '', modifiers: [] } },
    'Menu/Edit/Clear Protected Properties': { path: ['Edit', 'Clear Protected Properties'], shortcut: { key: '', modifiers: [] } },
