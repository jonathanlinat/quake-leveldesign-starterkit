...
3. Copy the `.pak` files from your original Quake game installation into the `id1` directory:
   - `pak0.pak` and `pak1.pak` from the original Quake game release.
   - `pak0.pak` from the Quake re-release.
